...
class Peer {
    ...
    onMessage(message) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return yield this.fatalError(`Failed to parse incoming message as JSON: ${message}`);
            }
            if (!message_1.Message.guard(msg)) {
                const validation = message_1.Message.validate(msg);
                return yield this.fatalError(`The received message does not match one of the known message formats: ${message}
         Validation error: ${JSON.stringify(validation)}`);
            ...
            if (!this.handshakeCompleted) {
                ...
                return yield this.fatalError(`Received message ${message} prior to "hello"`);
            }
            message_1.Message.match(() => __awaiter(this, void 0, void 0, function* () {
                return yield this.fatalError(`Received a second "hello" message, even though handshake is completed`);
    ...
    onMessageHello(msg) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!semver_1.default.satisfies(msg.version, `^${VERSION}`)) {
                return yield this.fatalError(`You sent an incorrect version (${msg.version}), which is not compatible with this node's version ${VERSION}.`);
            }
    ...
    onMessageObject(msg) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield object_1.objectManager.validate(msg.object, this);
            }
            catch (e) {
                this.sendError(`Received invalid object: ${e.message}`);
                yield object_1.objectManager.del(objectid);
                return;
            }
            if (!known) {
                // gossip
    ...
    onMessageGetChainTip(msg) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.sendChainTip(block_1.chaintip);
        });
    }
